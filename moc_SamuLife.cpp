...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_SamuLife_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 22, 6) // "bool**"

    },
    "SamuLife\0updateCells\0\0bool**"
};
...
const QMetaObject SamuLife::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_SamuLife.data,
      qt_meta_data_SamuLife,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *SamuLife::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_SamuLife.stringdata))
