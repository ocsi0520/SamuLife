...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_GameOfLife_t, stringdata) + ofs \
...
QT_MOC_LITERAL(3, 25, 6) // "bool**"

    },
    "GameOfLife\0cellsChanged\0\0bool**"
};
...
void GameOfLife::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->cellsChanged((*reinterpret_cast< bool**(*)>(_a[1])),(*reinterpret_cast< bool**(*)>(_a[2]))); break;
        default: ;
        }
        ...
        {
            typedef void (GameOfLife::*_t)(bool * * , bool * * );
...
const QMetaObject GameOfLife::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_GameOfLife.data,
      qt_meta_data_GameOfLife,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
// SIGNAL 0
void GameOfLife::cellsChanged(bool * * _t1, bool * * _t2)
{
